...
iva_lacteos = float(input("Escriba el valor del iva lacteos: "))
iva_gaseosas = float(input("Escriba el valor del iva gaseosas: "))
iva_carnicos = float(input("Escriva el valor del iva carnicos: "))
iva_otros = float(input("Escriba el valor del iva otros: "))
